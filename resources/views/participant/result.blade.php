...
<div class="container">
    ...
    <div class="card mb-4">
        <div class="card-body text-center">
            <h4>Total Skor</h4>
            <h2 class="mb-0">Nilai: <b>{{ number_format(($totalCorrect / max(1, $totalQuestions)) * 100, 0) }}%</b></h2>
                        ...
                        <table class="table table-borderless table-sm">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td class="text-end">{{ $data['total'] > 0 ? number_format(($data['correct'] / $data['total']) * 100, 0) : 0 }}%</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
