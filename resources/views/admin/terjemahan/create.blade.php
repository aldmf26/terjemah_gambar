...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title fw-semibold">Form Tambah Terjemahan</h5>
            <form action="{{ route('admin.terjemahan.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row" x-data="{
                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-xl-3 mb-3 p-3">
                        <div class="position-relative" x-show="imageBy === 'upload'">
                            <img id="bookCoverPreview" src="{{ asset('uploads/book_cover/default.jpg') }}" alt=""
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="mb-3 mt-1">
                            ...
                            <input class="form-control @error('image') is-invalid @enderror" :type="imageBy === 'upload' ? 'file' : 'text'" id="image"
                        ...
                        <div class="mb-3">
                            ...
                            <input placeholder="input kata tanpa spasi" @input="$event.target.value = $event.target.value.replace(/\s/g, '')" type="text" class="form-control @error('ind') is-invalid @enderror" id="ind"
                        ...
                        <div class="mb-3">
                            ...
                            <input placeholder="input kata tanpa spasi" @input="$event.target.value = $event.target.value.replace(/\s/g, '')" type="text" class="form-control @error('en') is-invalid @enderror" id="en"
