    ...
    <div class="card shadow-sm border-0 rounded-3">
        <div class="card-body">
            <h4 class="card-title fw-bold text-primary mb-4">
                <i class="ti ti-edit me-2"></i>Edit Kata Scramble
            </h4>

            <form action="{{ route('scramble-words.update', $word->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <!-- Preview Image -->
                    <div class="col-12 col-md-4 mb-4 text-center">
                        <div class="border rounded p-3 bg-light">
                            ...
                            <img id="imagePreview" src="{{ $word->illustration_image ? asset($word->illustration_image) : asset('uploads/book_cover/default.jpg') }}" 
                    ...
                    <div class="col-12 col-md-8">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('original_word') is-invalid @enderror" 
                                    id="original_word" name="original_word" placeholder="Contoh: gambut" value="{{ old('original_word', $word->original_word) }}" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('scrambled_word') is-invalid @enderror" 
                                    id="scrambled_word" name="scrambled_word" placeholder="Contoh: tabmug" value="{{ old('scrambled_word', $word->scrambled_word) }}" required>
                                <div class="invalid-feedback">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <select class="form-select @error('level_tier') is-invalid @enderror" id="level_tier" name="level_tier" required>
                                    ...
                                    <option value="1" {{ old('level_tier', $word->level_tier) == 1 ? 'selected' : '' }}>1 - Beginner</option>
                                    <option value="2" {{ old('level_tier', $word->level_tier) == 2 ? 'selected' : '' }}>2 - Intermediate</option>
                                    <option value="3" {{ old('level_tier', $word->level_tier) == 3 ? 'selected' : '' }}>3 - Advanced</option>
                                </select>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <span class="text-muted small">Format: JPG, PNG, JPEG. Maksimal 2MB. Biarkan kosong jika tidak ingin diubah.</span>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('scientific_description') is-invalid @enderror" 
                                ...
                                placeholder="Masukkan penjelasan ilmiah mengenai kata ini ketika nanti berhasil ditebak user..." required>{{ old('scientific_description', $word->scientific_description) }}</textarea>
                            <div class="invalid-feedback">
